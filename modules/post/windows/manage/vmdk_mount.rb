...
class MetasploitModule < Msf::Post
  ...
  def initialize(info={})
    super(update_info(info,
        ...
        'References'    =>
        [
          [ 'URL', 'https://www.youtube.com/watch?v=5Ou6HQB6oow&vq=hd1080' ]
        ],
        'Platform'      => [ 'win'],
  ...
  def open_mountserver(path)
    ...
    # If the vixDiskMountServer process is created by vmware (when the mapping utility is called) it will not be
    # possible to mount the file. In this case killing vixDiskMountServer manually and re-running the script
    # could be a solution but this action could be noisy and raise suspicions.
